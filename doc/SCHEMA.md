...
| 23 | 競走種別コード | str | ○ | KYOSO_SHUBETSU_CODE | "11"=サラ系2歳,"12"=サラ系3歳,"13"=サラ系3歳以上,"14"=サラ系4歳以上,"18"=サラ障害3歳以上等。コードで保持。scraping側は名称からコードに変換 |
| 24 | 競走記号コード | str | ○ | KYOSO_KIGO_CODE | "N01"=(国際)(指定),"A03"=(混合)[指定]等。コードで保持 |
...
| 34 | トラックコード | str | ○ | TRACK_CODE | コードで保持 |
| 35 | 変更前トラックコード | str | × | HENKOMAE_TRACK_CODE | コードで保持 |
...
| 64 | 芝馬場状態コード | str | ○ | SHIBA_BABAJOTAI_CODE | "1"=良,"2"=稍重,"3"=重,"4"=不良。コードで保持 |
| 65 | ダート馬場状態コード | str | ○ | DIRT_BABAJOTAI_CODE | "1"=良,"2"=稍重,"3"=重,"4"=不良。コードで保持 |
...
| 34 | 増減差 | int | ○ | ZOGEN_SA | |
| 35 | 異常区分コード | str | ○ | IJO_KUBUN_CODE | "0"=正常,"1"=出走取消,"2"=発走除外,"3"=競走除外,"4"=競走中止,"5"=失格,"6"=落馬再騎乗,"7"=降着。コードで保持。異常区分対応表参照 |
...
| 異常区分コード | IJO_KUBUN_CODEをそのまま保持 | そのまま | コードで保持 |
