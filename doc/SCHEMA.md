...
| 4 | 競馬場コード | str | ○ | KEIBAJO_CODE | scraping側は名称からコードに変換 |
| 5 | 開催回 | int | ○ | KAISAI_KAI | 第N回 |
| 6 | 開催日目 | int | ○ | KAISAI_NICHIME | N日目 |
| 7 | レース番号 | int | ○ | RACE_BANGO | |
| 8 | 曜日コード | str | ○ | YOBI_CODE | scraping側は名称からコードに変換 |
...
| 21 | グレードコード | str | ○ | GRADE_CODE | "A"=G1,"B"=G2,"C"=G3,"F"=JG1,"L"=L,"E"=特別,"_"=一般競走。scraping側はG1→A等に変換 |
| 22 | 変更前グレードコード | str | × | HENKOMAE_GRADE_CODE |  |
| 23 | 競走種別コード | str | ○ | KYOSO_SHUBETSU_CODE | "11"=サラ系2歳,"12"=サラ系3歳,"13"=サラ系3歳以上,"14"=サラ系4歳以上,"18"=サラ障害3歳以上等。scraping側は名称からコードに変換 |
| 24 | 競走記号コード | str | ○ | KYOSO_KIGO_CODE | "N01"=(国際)(指定),"A03"=(混合)[指定]等。 |
| 25 | 重量種別コード | str | ○ | JURYO_SHUBETSU_CODE | scraping側は名称からコードに変換 |
...
| 34 | トラックコード | str | ○ | TRACK_CODE |  |
| 35 | 変更前トラックコード | str | × | HENKOMAE_TRACK_CODE |  |
| 36 | コース区分 | str | ○ | COURSE_KUBUN | "A","B","C","D" |
| 37 | 変更前コース区分 | str | × | HENKOMAE_COURSE_KUBUN |  |
...
| 63 | 天候コード | str | ○ | TENKO_CODE | scraping側は名称からコードに変換 |
| 64 | 芝馬場状態コード | str | ○ | SHIBA_BABAJOTAI_CODE | "1"=良,"2"=稍重,"3"=重,"4"=不良。 |
| 65 | ダート馬場状態コード | str | ○ | DIRT_BABAJOTAI_CODE | "1"=良,"2"=稍重,"3"=重,"4"=不良。 |
...
| 57 | 1コーナー周回数 | int | × | SHUKAISU（コーナー番号対応） | mykeibadb: CORNER{i}の値で実際のコーナー番号に対応して格納 |
| 58 | 1コーナー通過順 | str | ○ | KAKU_TSUKA_JUNI（コーナー番号対応） | 馬番の通過順文字列。存在しないコーナーはNaN |
| 59 | 2コーナー周回数 | int | × | SHUKAISU（コーナー番号対応） | |
| 60 | 2コーナー通過順 | str | ○ | KAKU_TSUKA_JUNI（コーナー番号対応） | |
| 61 | 3コーナー周回数 | int | × | SHUKAISU（コーナー番号対応） | |
| 62 | 3コーナー通過順 | str | ○ | KAKU_TSUKA_JUNI（コーナー番号対応） | |
| 63 | 4コーナー周回数 | int | × | SHUKAISU（コーナー番号対応） | |
| 64 | 4コーナー通過順 | str | ○ | KAKU_TSUKA_JUNI（コーナー番号対応） | |
| 65 | レコード更新区分 | str | × | RECORD_KOSHIN_KUBUN | |
...
| 12 | 馬記号コード | str | × | UMAKIGO_CODE |  |
| 13 | 性別コード | str | △ | SEIBETSU_CODE | "1"=牡,"2"=牝,"3"=セン。△=get_entry/get_resultのみ対応（get_past_performancesは取得不可）|
| 14 | 品種コード | str | × | HINSHU_CODE |  |
| 15 | 毛色コード | str | × | MOSHOKU_CODE |  |
| 16 | 馬齢 | int | △ | BAREI | △=get_entry/get_resultのみ対応（get_past_performancesは取得不可）|
| 17 | 所属コード | str | △ | TOZAI_SHOZOKU_CODE | "1"=関東,"2"=関西,"3"=地方招待,"4"=外国招待。△=get_entry/get_resultのみ対応（get_past_performancesは取得不可）|
...
| 34 | 増減差 | int | ○ | ZOGEN_SA | |
| 35 | 異常区分コード | str | ○ | IJO_KUBUN_CODE | "0"=正常,"1"=出走取消,"2"=発走除外,"3"=競走除外,"4"=競走中止,"5"=失格,"6"=落馬再騎乗,"7"=降着。異常区分対応表参照 |
...
| 41 | 着差コード1 | str | ○ | CHAKUSA_CODE1 | "K__","_12","_34"等の着差コード。 |
| 42 | 着差コード2 | str | × | CHAKUSA_CODE2 |  |
| 43 | 着差コード3 | str | × | CHAKUSA_CODE3 |  |
...
| 14 | 重賞1グレードコード | str | × | JUSHO1_GRADE_CODE |  |
| 15 | 重賞1競走種別コード | str | × | JUSHO1_KYOSO_SHUBETSU_CODE |  |
| 16 | 重賞1競走記号コード | str | × | JUSHO1_KYOSO_KIGO_CODE |  |
| 17 | 重賞1重量種別コード | str | × | JUSHO1_JURYO_SHUBETSU_CODE |  |
| 18 | 重賞1距離 | int | × | JUSHO1_KYORI | |
| 19 | 重賞1トラックコード | str | × | JUSHO1_TRACK_CODE |  |
...
| 26 | 重賞2グレードコード | str | × | JUSHO2_GRADE_CODE |  |
| 27 | 重賞2競走種別コード | str | × | JUSHO2_KYOSO_SHUBETSU_CODE |  |
| 28 | 重賞2競走記号コード | str | × | JUSHO2_KYOSO_KIGO_CODE |  |
| 29 | 重賞2重量種別コード | str | × | JUSHO2_JURYO_SHUBETSU_CODE |  |
| 30 | 重賞2距離 | int | × | JUSHO2_KYORI | |
| 31 | 重賞2トラックコード | str | × | JUSHO2_TRACK_CODE |  |
...
| 38 | 重賞3グレードコード | str | × | JUSHO3_GRADE_CODE |  |
| 39 | 重賞3競走種別コード | str | × | JUSHO3_KYOSO_SHUBETSU_CODE |  |
| 40 | 重賞3競走記号コード | str | × | JUSHO3_KYOSO_KIGO_CODE |  |
| 41 | 重賞3重量種別コード | str | × | JUSHO3_JURYO_SHUBETSU_CODE |  |
| 42 | 重賞3距離 | int | × | JUSHO3_KYORI | |
| 43 | 重賞3トラックコード | str | × | JUSHO3_TRACK_CODE |  |
