...
| 21 | グレード | str | ○ | GRADE_CODE→グレード名 | "G1","G2","G3","L","OP"等。コード変換後 |
| 22 | 変更前グレード | str | × | HENKOMAE_GRADE_CODE→グレード名 | コード変換後 |
...
| 41 | 着差1 | str | ○ | CHAKUSA_CODE1→着差名 | "クビ","1/2","3/4"等。コード変換後 |
| 42 | 着差2 | str | × | CHAKUSA_CODE2→着差名 | コード変換後 |
| 43 | 着差3 | str | × | CHAKUSA_CODE3→着差名 | コード変換後 |
