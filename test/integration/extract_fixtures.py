...
使用方法:
    MYKEIBADB_HOST=host.docker.internal python test/integration/extract_fixtures.py
"""
...
SCRAPING_HTML_DIR = Path(__file__).parent / "../../../keiba-scraping/test/fixtures/html"
SCRAPING_FIXTURES_DIR = Path(__file__).parent / "../../../keiba-scraping/test/fixtures"
